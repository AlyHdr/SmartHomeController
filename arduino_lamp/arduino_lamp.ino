...
void turnOn(){
  ...
  if(client.connect(server, 80)){
    Serial.println("connected !");
     client.println("PUT /api/LDd1NE7AhgJ6bJ-SZ-g1zCkydqssE2wd5Lwe7lMU/lights/15/state HTTP/1.1");
...
void httpRequest(){
  ...
  if (client.connect(server, 80)) {
    ...
    // Make a HTTP request:
    client.println("GET /api/LDd1NE7AhgJ6bJ-SZ-g1zCkydqssE2wd5Lwe7lMU/lights/15 HTTP/1.1");
    client.println("Host: 192.168.1.131");
